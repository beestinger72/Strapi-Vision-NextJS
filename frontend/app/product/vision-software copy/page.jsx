...
async function getSeoData(){
     return (await fetch(baseURL + "/pages/12?populate=*")).json()
}
async function getPageData(){
return await (await fetch(baseURL + "/pages/12?populate[ContentBlocks][populate]=*")).json()
   
}
async function getData(){
return await (await fetch(baseURL + "/pages/12?populate[PageLeft][populate]=*")).json()
   
}
async function getRightBlock(){
return await (await fetch(baseURL + "/pages/12?populate[PageRight][populate]=*")).json()
