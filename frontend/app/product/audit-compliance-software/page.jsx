...
async function getSeoData(){
     return (await fetch(baseURL + "/pages/10?populate=*")).json()
}
async function getPageData(){
return await (await fetch(baseURL + "/pages/10?populate[ContentBlocks][populate]=*")).json()
   
}
async function getData(){
return await (await fetch(baseURL + "/pages/10?populate[PageLeft][populate]=*")).json()
   
}
async function getRightBlock(){
return await (await fetch(baseURL + "/pages/10?populate[PageRight][populate]=*")).json()
...
const pagedata = use(getSeoData());
  return (
    <>
      ...
      <Cover  data={pagedata.data.attributes}/>
      {/* <Breadcrumb
