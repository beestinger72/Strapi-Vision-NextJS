...
async function getSeoData(){
     return (await fetch(baseURL + "/pages/15?populate=*")).json()
}
async function getPageData(){
return await (await fetch(baseURL + "/pages/15?populate[ContentBlocks][populate]=*")).json()
   
}
async function getData(){
return await (await fetch(baseURL + "/pages/15?populate[PageLeft][populate]=*")).json()
   
}
async function getRightBlock(){
return await (await fetch(baseURL + "/pages/15?populate[PageRight][populate]=*")).json()
