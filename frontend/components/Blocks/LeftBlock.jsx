...
const LeftBlock = ({ block , fallBackSrc = fallback.src }) => {
...
return (
    ...
    <section className="leftblock relative pt-[100px] pb-[100px] border-b">  
   ...
   <div className="container">
        <div className=" ">
          ...
          <div className="max-w-[570px]">
           <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-500 font-semibold text-xl border-b-2 border-blue-100 "> {PageLeft.TitleBadge}</span>
